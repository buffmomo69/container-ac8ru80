...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-ac8ru80.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-ac8ru80.containers.anotherwebservice.com/
...
```
git clone git@github.com:buffmomo69/container-ac8ru80.git
cd container-ac8ru80
```
...
```
docker attach container-ac8ru80
```
